...
const currencies = [
  ...
  { code: 'LRD', symbol: '$', name: 'LD Dollar' },
...
const LanguageSelector = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-25 z-[100] flex items-start justify-center pt-20">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-[1000px] max-h-[85vh] overflow-y-auto">
